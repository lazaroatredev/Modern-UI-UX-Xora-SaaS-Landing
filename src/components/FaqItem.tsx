...
const FaqItem = ({ answer, index, id, question }: FaqItemProps) => {
  ...
  return (
    <div className="relative z-2 mb-16">
      ...
      <div
        className={clsx("g-5 absolute -top-7 -bottom-7 left-0 right-0 -z-1 rounded-3xl opacity-0 transition-opacity duration-500",active && "opacity-100")}
      >
