import { afterpay, aliciaBarker, amplitude, beckySnider, circle, detail1, detail2, detail3, detail4, discord, docs, drips, feature1, feature2, hexagon, instagram, jessicasaunders, jimBradley, magicTouch, markErixon, maze, melanieHurst, plan1, plan2, plan3, sonos, threads, triangle, x } from "../assets";
